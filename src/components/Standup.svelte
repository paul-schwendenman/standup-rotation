...
<div style="text-align: center">
  <div class="button" id="startButton"><label class="unselectable">start</label></div>
  <div class="button" id="shuffleButton"><label class="unselectable">shuffle</label></div>
  <div class="button" id="nextButton"><label class="unselectable">next</label></div>
  <div class="button" id="skipButton"><label class="unselectable">re-enqueue</label></div>
</div>
